...
def main():
    ...
    parser.add_argument('-p', '--plasmid', dest='plasmid', nargs='+',
                        required=True, help='Provide the plasmid fastas')
    parser.add_argument('-r', '--read', dest='reads', nargs='+', required=True,
    ...
    parser.add_argument('-o', '--output', dest='output_name', required=True,
                        help='Specify the output name you wish. No need for file extension!')
    parser.add_argument('-unmap', '--unmapped', dest='unmapped_reads',
                        action='store_true',
                        help='By default this script attempts to save sequences available in the provided read files. If you want to save the reads that do not belong to plasmids, use this option.')
    ...
    for read in args.reads:
        ...
        mapper(idx_file, read, threads, main_file, args.output_name,
               args.unmapped_reads)
